// TODO:
// - Implement modal for "Apply Now" button (for when application is closed, link to app when open)

import React, { useState } from "react";
import BasicModal from "./Modal";
import HeroImage from "../images/product-management-marketing-books.jpg";
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p
                ...
                data-aos-delay="150"
              >
                Empower yourself to build stunning valuable and meaningful
                products
              </p>
              <div
