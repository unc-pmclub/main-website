// TODO:
// - Create separate MailChimp mailing list for website
// - Add functionality to mailing list "Subscribe" button
          ...
          >
              ...
              <svg width="428" height="328" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  ...
                  >
                    ...
                    <stop stopColor="#EE4446" offset="44.317%" />
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Stay Updated with PM!</h3>
                <p className="text-gray-300 text-lg mb-6">
                  Subscribe to get updates on our upcoming events and
                  opportunities.
                </p>
